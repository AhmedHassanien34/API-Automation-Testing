package tests.Authentication; // Adjust the package name as per your project structure
...
public class LoginApiTest {
    ...
    public void ValidEmailandValidPasswordLogin() throws IOException {
        ...
        Assert.assertTrue(response.jsonPath().getBoolean("isAccountVerified"),"isAccountVerified should be True!");
