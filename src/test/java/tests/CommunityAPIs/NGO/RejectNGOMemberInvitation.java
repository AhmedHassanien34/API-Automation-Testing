...
public class RejectNGOMemberInvitation {

    private String authToken;

    @BeforeClass
    public void ValidEmailandValidPasswordLogin() throws IOException {
        Map<String, Object> requestBody = RestClient.getTestData("Member2Login");
    ...
    @Test(priority = 1)
    public void RejectNGOMemberInvitationTest(){
        ...
        Response response = given()
                ...
                .post("/api/communities/"+ communityId + "/ngo-members/reject");

        if (response.getStatusCode() != 201)
        {
            System.out.println("End Point: /api/communities/"+ communityId + "/ngo-members/reject");
    ...
    @Test(priority = 2)
    public void RejectNGOMemberInvitationWithInvitationAlreadyRejectedTest(){
        ...
        Assert.assertEquals(errorMessage, "Invitation doesn't exist", "Error message mismatch!");
    }


    @Test(priority = 3)
    public void RejectNGOMemberInvitationWithInvalidCommunityIdTest(){
    ...
    @Test(priority = 4)
    public void RejectNGOMemberInvitationWithNonExistCommunityIdTest(){
    ...
    @Test(priority = 5)
    public void RejectNGOMemberInvitationWithMissingCommunityIdTest(){
    ...
    @Test(priority = 6)
    public void RejectNGOMemberInvitationWithMissingTokenTest(){
