...
public class RegisterApiTest {
    ...
    @Test(priority = 1)
        public void SuccessfulRegisterTest() throws IOException {
            ...
            Assert.assertEquals(response.jsonPath().getString("email"), "hassaniengivers+5014@gmail.com", "Email mismatch!");
            Assert.assertFalse(response.jsonPath().getBoolean("isEmailVerified"), "isEmailVerified should be false!");
            Assert.assertFalse(response.jsonPath().getBoolean("isAccountActive"),"isAccountActive should be false!");
